...
# verificar se o site permite a extracao de dados
...
for doctoralia in soup.find_all('div', {'class': 'card card-shadow-1 mb-1'}):
    ...
    # extrair os nomes dos doutores
    nome = doctoralia.find('span', {'itemprop': 'name'}).text.strip()
    dados['Nome'].append(nome)
    
    # extrair a especialidade de cada um dos doutores
    ...
    # extrair os valores das primeiras consultas com os doutores
    ...
    # extrair o endereco do consultorio dos doutores
    endereco = doctoralia.find('span', {'class': 'text-truncate'}).text
    dados['Endereco'].append(endereco)
    
    # extrair as opinioes dos pacientes para cada um dos doutores
    ...
    # verificar se o perfil dos doutores sao verificados
    perfil_verificado = []
    ...
    # verificar se os doutores tem fidelidade com os pacientes
    fidelidade =  []
    ...
    # verificar se os doutores sao assinantes novos, de primeira classe ou nao tem a assinatura
    assinatura = []
